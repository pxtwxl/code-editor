...
import { Lock,ChevronDownIcon, Sparkles } from 'lucide-react';
...
function LanguageSelector({hasAccess} : {hasAccess : boolean}) {
    ...
    const handleLanguageSelect = (langId:string) => {
        if(!hasAccess && langId !== "cpp" && langId !== "java" && langId !== "python") return;
    ...
    <div className='relative' ref={dropdownRef}>
        <motion.button
            ...
            ${!hasAccess && language !== "cpp" && language !== "java" && language !== "python" ? "opacity-50 cursor-not-allowed" : ""}`}
        >
          ...
          >
            ...
            <div className="max-h-[280px] overflow-y-auto overflow-x-hidden">
              {Object.values(LANGUAGE_CONFIG).map((lang, index) => {
                const isLocked = !hasAccess && lang.id !== "cpp" && lang.id !== "java" && lang.id !== "python";
